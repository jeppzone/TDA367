...
import edu.chalmers.RunningMan.util.map.MapHandler;
import edu.chalmers.RunningMan.util.map.MapHandlerException;
...
public class GameController implements PropertyChangeListener {
    ...
    /**
     * Updates all controller in the game
    ...
    /**
     * The controller that should be updated after
     ...
     * the level is up. If it is, change screen accordingly
     */
